...
SRC_DIR = src
SRC = $(SRC_DIR)/player.c $(SRC_DIR)/joystick.c $(SRC_DIR)/movement.c $(SRC_DIR)/platform.c $(SRC_DIR)/collision.c $(SRC_DIR)/animations.c $(SRC_DIR)/render.c $(SRC_DIR)/main.c
